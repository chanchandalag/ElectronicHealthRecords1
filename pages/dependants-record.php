<div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Dependants Record</b></h3>
              ...
              <div class="card-body">
                 ...
                 <?php
                  if(isset($_GET['status']) && $_GET['status'] === 'success'){
                      ...
                      echo '<div class="alert alert-info"><i class="fa fa-envelope"></i> This screen displays the dependants record</div>';                        
                  }
                ?>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php
                      $query = "SELECT * FROM patient WHERE pt_type = 0";
                       ...
                       <td >
                          <a class="btn btn-primary btn-sm dropdown-toggle dropdown-toggle-hover" href="#" data-toggle="dropdown"><i class="fas fa-share-square"></i> Send</a>
                            <ul class="dropdown-menu">
                              <li>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure you want to send this into Medical')" href="/pages/medical-send.php?id=<?=$rows['id'];?>&type=0" class="fa fa-heartbeat"> Medical Records</a></li>
                              <li>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure you want to send this into Dental')" href="/pages/dependant-dental-send.php?id=<?=$rows['id'];?>" class="fa fa-hospital"> Dental Records</a></li>
                            </ul>
